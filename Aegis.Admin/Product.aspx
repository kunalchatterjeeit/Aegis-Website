<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Aegis.Admin.Product" %>
            ...
            <asp:GridView ID="gvCategory" runat="server" Width="100%" AutoGenerateColumns="false" class="table table-striped"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-Width="15px">
                        <ItemTemplate>
                            <asp:Button ID="btnFeature" runat="server" class="btn btn-outline btn-success" Text="Feature" CommandName="Feature" CommandArgument='<%# Eval("Id") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-Width="15px">
                        <ItemTemplate>
                            <asp:Button ID="btnDisplay" runat="server" class="btn btn-outline btn-success" Text="Photo" CommandName="Display" CommandArgument='<%# Eval("Id") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-Width="15px">
                        <ItemTemplate>
